...
import { BIZ_PHONE, BIZ_TEL_HREF, INSTA_1, INSTA_2 } from "@/lib/site";
import { BASE_GRAPH, breadcrumb, articleSchema, graph } from "@/lib/schemas";

const PATH = "/reviews/";
const TITLE = "방문 후기 모음 | 왜 단골들이 짱구만 찾는가 — 솔직 톤";
...
const VOICES = [
  ...
  { tag: "단골 / 4년차", body: "주말 골든타임에 자리 잡기 어려운 곳들 많은데, 짱구한테 미리 한 통 부탁드리면 동선이 완전히 달라집니다. 그래서 계속 찾게 됨." },
    ...
    <>
      ...
      <header className="hero hero-sub">
        <div className="hero-inner">
          ...
          <h1>왜 단골들이 <span className="grad">짱구만</span> 찾는가.</h1>
      ...
      <main className="wrap">
        ...
        <section className="ps">
          <h3>방문 후 후기 남기실 분</h3>
          <p>인스타 DM 또는 짱구 <a href={BIZ_TEL_HREF}>{BIZ_PHONE}</a>로 한 줄 톡 부탁드립니다. 매장 운영에 그대로 반영됩니다.</p>
        </section>
      </main>
