  ...
  return (
    <>
      ...
      <main className="wrap">
        ...
        <section>
          <h2>음주 시 권장 동선</h2>
          <p>마시고 운전은 결코 금지입니다. 음주가 예정된 자리라면 처음부터 대중교통·택시로 오시거나, 차를 가져오신 경우 대리운전을 부르세요. 상남동 권은 대리 콜 응답이 빨라 5~10분 내 도착이 일반적입니다. 자세한 대중교통 동선은 <a href="/access/">대중교통 페이지</a>에서.</p>
        </section>
